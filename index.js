    ...
    try:
        ...
        for attempt in range(3):
            try:
                ...
                # Strict markdown table parse - only zone rows, skip immunities
                ...
                for line in lines:
                    ...
                    if stripped.startswith('|  |') and '---' not in stripped:
                        ...
                        if len(parts) == 2:  # |  | zone
                            zone_text = parts[1]
                            # Skip immunities row
                            if 'IMMUN' in zone_text or 'MONSTERS WITH' in zone_text or 'COLD' in zone_text or 'FIRE' in zone_text or 'LIGHTNING' in zone_text or 'POISON' in zone_text or 'MAGIC' in zone_text:
                                continue
