    ...
    try:
        ...
        for attempt in range(3):
            try:
                ...
                # Strict markdown table parse - look for |  | zone | ...
                ...
                for line in lines:
                    ...
                    if stripped.startswith('|') and '|' in stripped[1:]:
                        ...
                        if len(parts) >= 3 and '---' not in parts and 'IMMUN' not in ' '.join(parts):
                            zone_text = parts[2]  # usually third column for zone
                ...
                # Fallback if no table zones found
